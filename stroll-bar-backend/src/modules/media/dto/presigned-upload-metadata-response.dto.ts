...
export class PresignedUploadMetadataResponseDto {
  ...
  @ApiProperty({ example: 'https://cdn.example.com/stroll/f7f3eb6a-711b-49e8-ae60-b7af77fa35c6/2026/07/18/3d7cc2cf-cover.jpg' })
  publicUrl!: string;

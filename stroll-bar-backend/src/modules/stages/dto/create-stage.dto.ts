...
export class CreateStageDto {
	...
	@ApiPropertyOptional({ type: [String], example: ['https://example.com/stage.jpg'], maxItems: 5 })
	@IsOptional()
	@IsArray()
	@ArrayMaxSize(5)
	@IsUrl({}, { each: true })
	...
	@ApiPropertyOptional({ type: [String], example: ['https://example.com/stage.mp4'], maxItems: 1 })
	@IsOptional()
	@IsArray()
	@ArrayMaxSize(1)
	@IsUrl({}, { each: true })

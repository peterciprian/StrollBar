...
@Component({
	selector: 'app-admin-station-editor-screen',
	standalone: true,
	imports: [
		CommonModule,
		UpperCasePipe,
	...
	templateUrl: './admin-station-editor.component.html',
	styleUrls: ['./admin-station-editor.component.scss']
})
export class AdminStationEditorScreenComponent {
	...
	protected get selectedStation(): EditableStation {
		return this.stations.find((s) => s.id === this.selectedStationId) ?? this.stations[0];
	}

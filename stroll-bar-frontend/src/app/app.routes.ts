...
import { AdminBadgeListScreenComponent } from './pages/admin/admin-badge-list/admin-badge-list.component';
import { AdminIssuesScreenComponent } from './pages/admin/admin-issues/admin-issues.component';
